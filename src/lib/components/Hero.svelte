...
<Section sectionId="hero" zIndex="z-[10]">
	<section class="h-full flex justify-center items-center bg-hero">
		<div class="relative flex flex-col-reverse md:flex-row justify-center items-center">
			<div>
				<div class="overflow-clip">
					<h1 class="text-6xl md:text-7xl lg:text-9xl px-4 py-2 text-right animate-hero-title">
						Tired<br />Blue Whale
					</h1>
				</div>
				<div class="flex justify-center">
					<div class="h-1 bg-white animate-hero-bar" />
				</div>
				<div class="overflow-clip">
					<h2 class="text-4xl md:text-5xl lg:text-6xl px-4 py-2 text-right animate-hero-sub-title">
						Works
					</h2>
				</div>
			</div>
			...
			<div class="overflow-clip">
				<img
					class="h-48 md:h-64 lg:h-96 aspect-square animate-hero-logo"
		...
		<div class="absolute bottom-0 left-0 right-0 flex justify-center animate-intro">
