...
export const Hero = ({ colorWaveBackground, colorWaveForeground }: HeroProps) => {
    return (
        <>
            <div className="h-screen sticky top-0 -z-10 scroll-snap flex flex-col justify-center sm:justify-start items-center sm:pt-[10vh]">
                <img src="tiredBlueWhale.png" alt="Tired Blue Whale Logo Large" className='max-h-[50vh] max-w-[80vw] pb-4 z-20' />
                <div className="flex flex-col px-8">
                    <span className="text-4xl sm:text-8xl text-center text-white">
                        Tired Blue Whale
                    </span>
            ...
            <div className="relative">
                <div className="absolute left-0 right-0 bottom-0 sm:bottom-5 -z-20">
